...
transformed parameters {
  ...
  for (l in 1:L) {
    ...
    for (i in 1:3) {
      A[i] = G[n, i]*val[n, i] + gam_sbj[sbj[n]]*(1 - G[n, i])*val[n, i];
    }

    drift_t[n, 1] = v_sbj[sbj[n]] + wd_sbj[sbj[n]]*(A[1] - A[2]) + ws_sbj[sbj[n]]*(A[1] + A[2]) + lambda_sbj[sbj[n]]*G[n, 1];
    drift_t[n, 2] = v_sbj[sbj[n]] + wd_sbj[sbj[n]]*(A[1] - A[3]) + ws_sbj[sbj[n]]*(A[1] + A[3]) + lambda_sbj[sbj[n]]*G[n, 1];
    drift_t[n, 3] = v_sbj[sbj[n]] + wd_sbj[sbj[n]]*(A[2] - A[1]) + ws_sbj[sbj[n]]*(A[2] + A[1]) + lambda_sbj[sbj[n]]*G[n, 2];
    drift_t[n, 4] = v_sbj[sbj[n]] + wd_sbj[sbj[n]]*(A[2] - A[3]) + ws_sbj[sbj[n]]*(A[2] + A[3]) + lambda_sbj[sbj[n]]*G[n, 2];
    drift_t[n, 5] = v_sbj[sbj[n]] + wd_sbj[sbj[n]]*(A[3] - A[1]) + ws_sbj[sbj[n]]*(A[3] + A[1]) + lambda_sbj[sbj[n]]*G[n, 3];
    drift_t[n, 6] = v_sbj[sbj[n]] + wd_sbj[sbj[n]]*(A[3] - A[2]) + ws_sbj[sbj[n]]*(A[3] + A[2]) + lambda_sbj[sbj[n]]*G[n, 3];
  }
}
