...
transformed parameters {
  ...
  transf_ndt = log(1 + exp(ndt));
    ...
    drift_t[n, 1] = transf_v + transf_wd*(val[n, 1] - val[n, 2]) + transf_ws*(val[n, 1] + val[n, 2]) + transf_lambda*G[n, 1];
    drift_t[n, 2] = transf_v + transf_wd*(val[n, 1] - val[n, 3]) + transf_ws*(val[n, 1] + val[n, 3]) + transf_lambda*G[n, 1];
    drift_t[n, 3] = transf_v + transf_wd*(val[n, 2] - val[n, 1]) + transf_ws*(val[n, 2] + val[n, 1]) + transf_lambda*G[n, 2];
    drift_t[n, 4] = transf_v + transf_wd*(val[n, 2] - val[n, 3]) + transf_ws*(val[n, 2] + val[n, 3]) + transf_lambda*G[n, 2];
    drift_t[n, 5] = transf_v + transf_wd*(val[n, 3] - val[n, 1]) + transf_ws*(val[n, 3] + val[n, 1]) + transf_lambda*G[n, 3];
    drift_t[n, 6] = transf_v + transf_wd*(val[n, 3] - val[n, 2]) + transf_ws*(val[n, 3] + val[n, 2]) + transf_lambda*G[n, 3];
  }
}
