...
transformed parameters {
  ...
  transf_ndt = log(1 + exp(ndt));
    ...
    drift_t[n, 1] = transf_v + transf_wd*(A[1] - A[2]) + transf_ws*(A[1] + A[2]);
    drift_t[n, 2] = transf_v + transf_wd*(A[1] - A[3]) + transf_ws*(A[1] + A[3]);
    drift_t[n, 3] = transf_v + transf_wd*(A[2] - A[1]) + transf_ws*(A[2] + A[1]);
    drift_t[n, 4] = transf_v + transf_wd*(A[2] - A[3]) + transf_ws*(A[2] + A[3]);
    drift_t[n, 5] = transf_v + transf_wd*(A[3] - A[1]) + transf_ws*(A[3] + A[1]);
    drift_t[n, 6] = transf_v + transf_wd*(A[3] - A[2]) + transf_ws*(A[3] + A[2]);
  }
}
