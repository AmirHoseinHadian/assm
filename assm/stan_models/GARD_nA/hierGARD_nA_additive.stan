...
transformed parameters {
  ...
  for (l in 1:L) {
    ...
    drift_t[n, 1] = v_sbj[sbj[n]] + wd_sbj[sbj[n]]*(val[n, 1] - val[n, 2]) + ws_sbj[sbj[n]]*(val[n, 1] + val[n, 2]) + lambda_sbj[sbj[n]]*G[n, 1];
    drift_t[n, 2] = v_sbj[sbj[n]] + wd_sbj[sbj[n]]*(val[n, 1] - val[n, 3]) + ws_sbj[sbj[n]]*(val[n, 1] + val[n, 3]) + lambda_sbj[sbj[n]]*G[n, 1];
    drift_t[n, 3] = v_sbj[sbj[n]] + wd_sbj[sbj[n]]*(val[n, 2] - val[n, 1]) + ws_sbj[sbj[n]]*(val[n, 2] + val[n, 1]) + lambda_sbj[sbj[n]]*G[n, 2];
    drift_t[n, 4] = v_sbj[sbj[n]] + wd_sbj[sbj[n]]*(val[n, 2] - val[n, 3]) + ws_sbj[sbj[n]]*(val[n, 2] + val[n, 3]) + lambda_sbj[sbj[n]]*G[n, 2];
    drift_t[n, 5] = v_sbj[sbj[n]] + wd_sbj[sbj[n]]*(val[n, 3] - val[n, 1]) + ws_sbj[sbj[n]]*(val[n, 3] + val[n, 1]) + lambda_sbj[sbj[n]]*G[n, 3];
    drift_t[n, 6] = v_sbj[sbj[n]] + wd_sbj[sbj[n]]*(val[n, 3] - val[n, 2]) + ws_sbj[sbj[n]]*(val[n, 3] + val[n, 2]) + lambda_sbj[sbj[n]]*G[n, 3];
  }
}
