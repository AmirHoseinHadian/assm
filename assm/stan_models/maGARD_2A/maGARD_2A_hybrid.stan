...
transformed parameters {
  ...
  for (n in 1:N) {
    ...
    A_o1_a1 = (G_o1_a1[n] + transf_gam_at*G_o1_a2[n] + transf_gam_op*G_o2_a1[n] + transf_gam_at*transf_gam_op*(1 - G_o1_a1[n] - G_o1_a2[n] - G_o2_a1[n])) * val_o1_a1[n] + G_o1_a1[n]*transf_lambda;
    A_o1_a2 = (G_o1_a2[n] + transf_gam_at*G_o1_a1[n] + transf_gam_op*G_o2_a2[n] + transf_gam_at*transf_gam_op*(1 - G_o1_a1[n] - G_o1_a2[n] - G_o2_a2[n])) * val_o1_a2[n] + G_o1_a2[n]*transf_lambda;
    
    A_o2_a1 = (G_o2_a1[n] + transf_gam_at*G_o2_a2[n] + transf_gam_op*G_o1_a1[n] + transf_gam_at*transf_gam_op*(1 - G_o2_a1[n] - G_o2_a2[n] - G_o1_a1[n])) * val_o2_a1[n] + G_o2_a1[n]*transf_lambda;
    A_o2_a2 = (G_o2_a2[n] + transf_gam_at*G_o2_a1[n] + transf_gam_op*G_o1_a2[n] + transf_gam_at*transf_gam_op*(1 - G_o2_a1[n] - G_o2_a2[n] - G_o1_a2[n])) * val_o2_a2[n] + G_o2_a2[n]*transf_lambda;
