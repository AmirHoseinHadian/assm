...
transformed parameters {
  ...
  transf_mu_ndt = log(1 + exp(mu_ndt));
    ...
    A_o1_a1 = G_o1_a1[n] * (val_o1_a1[n] + lambda_sbj[sbj[n]]);
    A_o1_a2 = G_o1_a2[n] * (val_o1_a2[n] + lambda_sbj[sbj[n]]);
    
    A_o2_a1 = G_o2_a1[n] * (val_o2_a1[n] + lambda_sbj[sbj[n]]);
    A_o2_a2 = G_o2_a2[n] * (val_o2_a2[n] + lambda_sbj[sbj[n]]);
