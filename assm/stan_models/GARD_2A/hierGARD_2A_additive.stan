...
transformed parameters {
  ...
  transf_mu_ndt = log(1 + exp(mu_ndt));
    ...
    drift_left_t[n]  = v_sbj[sbj[n]] + wd_sbj[sbj[n]]*(val1[n] - val2[n]) + ws_sbj[sbj[n]]*(val1[n] + val2[n]) + lambda_sbj[sbj[n]]*G1[n];
    drift_right_t[n] = v_sbj[sbj[n]] + wd_sbj[sbj[n]]*(val2[n] - val1[n]) + ws_sbj[sbj[n]]*(val2[n] + val1[n]) + lambda_sbj[sbj[n]]*G2[n];
  }
}
